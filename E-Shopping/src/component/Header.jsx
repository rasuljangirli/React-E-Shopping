...
import { setDrower } from "../redux/sclices/basketSlice";
...
function Header() {
  ...
  return (
    <div id="header_container" className="header_container">
      <div
        onClick={() => navigate("/")}
        className="flex_row header_container_logo"
      >
      ...
      <div className="flex_row">
        ...
        <Badge
          onClick={() => dispatch(setDrower())}
          badgeContent={useSelector((store) => store.basket.products.length)}
          color="error"
        >
